...
class RLHFDataset(Dataset):
    ...
    def _get_row(self, item: int) -> dict:
        """Return the raw row dict for *item*. Subclasses may override this to
        apply dynamic overrides (e.g. adaptive curriculum upgrades)."""
    ...
    def __getitem__(self, item):
        ...
        """
        row_dict: dict = self._get_row(item)
